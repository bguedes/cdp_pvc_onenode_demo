...
wget --progress=bar:force https://$USERNAME:$PASSWORD@archive.cloudera.com/p/cdsw1/1.10.2/csd/CLOUDERA_DATA_SCIENCE_WORKBENCH-CDPDC-1.10.2.jar -P /opt/cloudera/csd/	
